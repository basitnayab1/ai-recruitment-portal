...
import { changeHRPassword, type ChangePasswordState } from "@/lib/auth/actions";
import {
...
export function ChangePasswordForm() {
  const formId = useId();
  const [state, formAction, pending] = useActionState(changeHRPassword, initialState);
  ...
  return (
    <div className={`max-w-xl ${DETAIL_SECTION}`}>
      <div>
        <h2 className="text-base font-bold tracking-tight text-white">Security</h2>
