...
/**
 * Latest published jobs for the public landing page. Uses the anonymous
 * Supabase client — rows allowed by the "Public can view published jobs"
 * RLS policy.
 */
...
/**
 * Public headline stats for the landing page. Aggregate counts are fetched
 * server-side via the service-role client (counts only, never exposed rows).
 */
